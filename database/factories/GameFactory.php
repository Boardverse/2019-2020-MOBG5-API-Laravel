<?php
    ...
    $factory->define(User::class,
        function(Faker $faker) {
            ...
            $game_min_duration = rand(10, 45);
            $game_average_duration = rand($game_min_duration, $game_min_duration + 30);
            $game_max_duration = rand($game_average_duration, $game_average_duration + 30);
